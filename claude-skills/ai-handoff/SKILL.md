---
name: handoff
description: Use when the user writes /ai-handoff or wants to improve onboarding, project handoff, developer entry points, project structure understanding, key directories, common tasks, known pitfalls, command awareness, or AI/developer continuation guidance. Update the handoff guide, project structure doc, command reference if needed, and current status. Also follows the shared project-kickoff document-first workflow and supports related prefixes /ai-init, /ai-goal, /ai-goal --super, /ai-super, /ai-feature, /ai-change, /ai-fix, /ai-tech, /ai-deploy, /ai-handoff, /ai-roadmap, /ai-plan, /ai-status, /ai-continue, and /ai-upgrade.
---

# Handoff
## Claude Code Compatibility

This is the Claude Code alias of the 'handoff' workflow skill. Use the '/ai-handoff' slash command in Claude Code. The 'ai-' prefix avoids collisions with Claude Code built-in commands such as '/init', '/plan', and '/upgrade' while preserving the same document-first workflow semantics.
