---
name: roadmap
description: Use when the user writes /ai-roadmap or wants to adjust phases, MVP scope, priorities, milestones, launch readiness, or staged delivery plans. Update the roadmap, current status, and impacted docs. If roadmap changes imply major technology choices, use the technical-selection gate unless in /ai-goal --super mode. Also follows the shared project-kickoff document-first workflow and supports related prefixes /ai-init, /ai-goal, /ai-goal --super, /ai-super, /ai-feature, /ai-change, /ai-fix, /ai-tech, /ai-deploy, /ai-handoff, /ai-roadmap, /ai-plan, /ai-status, /ai-continue, and /ai-upgrade.
---

# Roadmap
## Claude Code Compatibility

This is the Claude Code alias of the 'roadmap' workflow skill. Use the '/ai-roadmap' slash command in Claude Code. The 'ai-' prefix avoids collisions with Claude Code built-in commands such as '/init', '/plan', and '/upgrade' while preserving the same document-first workflow semantics.
