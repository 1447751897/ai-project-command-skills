---
name: goal
description: Use when the user writes /ai-goal, /ai-goal --super, wants goal-mode execution, asks to fully complete a project or phase, or says they do not want to keep issuing per-feature commands. Create or enter a long-running objective when Goal tooling is available, initialize or continue project docs as needed, break the objective into tasks, autonomously progress through workflows, and if --super is present skip ordinary confirmations while recording key decisions. Also follows the shared project-kickoff document-first workflow and supports related prefixes /ai-init, /ai-goal, /ai-goal --super, /ai-super, /ai-feature, /ai-change, /ai-fix, /ai-tech, /ai-deploy, /ai-handoff, /ai-roadmap, /ai-plan, /ai-status, /ai-continue, and /ai-upgrade.
---

# Goal
## Claude Code Compatibility

This is the Claude Code alias of the 'goal' workflow skill. Use the '/ai-goal' slash command in Claude Code. The 'ai-' prefix avoids collisions with Claude Code built-in commands such as '/init', '/plan', and '/upgrade' while preserving the same document-first workflow semantics.
