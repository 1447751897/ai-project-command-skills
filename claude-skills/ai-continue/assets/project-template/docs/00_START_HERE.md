...
4. 设计关键词提炼：根据项目类型和参考风格，提炼整体气质、色彩、布局、卡片/组件风格、交互状态和需要避免的问题，并写入 `15-frontend-design.md`。
...
12. 如果影响产品形态、UI 风格、布局、组件策略、交互状态或前端体验边界，更新 `15-frontend-design.md`。
...
8. 如升级涉及前端设计规范，补充或更新 `docs/15-frontend-design.md`。
