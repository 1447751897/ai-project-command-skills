---
name: ai-init
description: Use when the user writes /ai-init or wants to initialize a new software project from a requirement description. Clarify the project goal, scaffold AI_DEVELOPMENT_RULES.md and docs, generate or update requirements, development principles, technical decisions, handoff guide, roadmap, local development, deployment docs, project structure docs, upgrade history, command reference, decision log, and current status before implementation. Also supports /ai-goal, /ai-goal --super, /ai-super, /ai-feature, /ai-change, /ai-fix, /ai-tech, /ai-deploy, /ai-handoff, /ai-roadmap, /ai-plan, /ai-status, /ai-continue, and /ai-upgrade for goal-mode automatic project execution, high-autonomy execution without ordinary confirmations, mid-project controlled requirement changes, feature recommendations when the user has no clear next step, cross-chat continuation, template upgrades, performance-aware design, and technical-selection gates.
---
