---
name: zno-review
description: Use when the user writes /zno-review or wants to review code before merging. Audits across 5 dimensions: security, performance, error handling, SOLID/DRY, and project conventions. Outputs findings as blocking items, suggestions, and reminders.
---
