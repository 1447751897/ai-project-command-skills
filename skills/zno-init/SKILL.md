---
name: init
description: Use when the user writes /init or wants to initialize a new software project from a requirement description. Clarify the project goal, scaffold AI_DEVELOPMENT_RULES.md and docs, generate or update requirements, development principles, technical decisions, handoff guide, roadmap, local development, deployment docs, project structure docs, upgrade history, command reference, decision log, frontend design direction, and current status before implementation. Also supports /goal, /goal --super, /super, /feature, /change, /fix, /tech, /deploy, /handoff, /roadmap, /plan, /status, /continue, and /upgrade for goal-mode automatic project execution, high-autonomy execution without ordinary confirmations, mid-project controlled requirement changes, feature recommendations when the user has no clear next step, cross-chat continuation, template upgrades, frontend design guidance, performance-aware design, and technical-selection gates.
---
...
- Downloads `https://github.com/1447751897/zno-project-command-skills` as a zip archive.
